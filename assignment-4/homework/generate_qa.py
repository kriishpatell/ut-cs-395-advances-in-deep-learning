...
def generate_qa_pairs(info_path: str, view_index: int, img_width: int = 150, img_height: int = 100) -> list:
    ...
    for kart in karts:
        ...
        qa_pairs.append({"question": f"Is {name} to the left or right of the ego car?", "answer": lr})
        qa_pairs.append({"question": f"Is {name} in front of or behind the ego car?", "answer": fb})
        qa_pairs.append({"question": f"Where is {name} relative to the ego car?", "answer": f"{fb} and {lr}"})
